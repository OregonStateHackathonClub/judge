...
export function MultiStepViewer({
  ...
  const stepFormElements: {
    ...
    1: <div><h1 className="text-3xl font-bold">Project Title & Description</h1>
...
<div className="py-3 w-full">
    ...
    2: <div><h1 className="text-3xl font-bold">Project Info</h1>
<div className="py-3 w-full">
                <Separator />
              </div>
...
<FormField
              ...
              /></div>,
    3: <div><h1 className="text-3xl font-bold">Project Review</h1>
      ...
      <div className="flex items-center justify-between gap-3 w-full pt-3">
        ...
        onClick={async () => {
          ...
          const fieldsToValidate = currentStep === 1
            ? ['name', 'description']
            : currentStep === 2
            ? ['mainDescription', 'github', 'youtube', 'photos']
            : [];
