...
export function MultiStepViewer({ form }: { form: any; }) {
  const stepFormElements: {
    ...
    // Step 1
    1: <div> <h1 className="text-3xl font-bold">Project Title & Mini-Description</h1>
    ...
    // Step 2
    2: <div> <h1 className="text-3xl font-bold">Main Description</h1>
    <div className="py-3 w-full">
        <Separator />
      </div>
      <FormField
    ...
    // Step 3
    3: <div><h1 className="text-3xl font-bold">Project Info</h1>
      <div className="py-3 w-full">
        <Separator />
      </div>
      <FormField
    ...
    4: <div><h1 className="text-3xl font-bold">Project Review</h1>
      <p className="text-base">Please review the information below to ensure everything is correct:</p>
      <h3 className="text-xl font-bold">Title: </h3>
      <h3 className="text-xl font-bold">Main Description:</h3>
      <h3 className="text-xl font-bold">GitHub: </h3>
      <h3 className="text-xl font-bold">YouTube:</h3></div>
  };
